...
| Field | Details |
|---|---|
| **Student Name** | *Anurag Saraf* |
| **Registration Number** |  *24BCE11067*|
| **Chosen Software** | Git |
...
```bash
git clone https://github.com/anurag24bce11067-del/Open_Source_Project_GIT.git
...
```
MIT License — Copyright (c) 2026 Anurag Saraf
